...
Future<Database> _initDatabase() async {
  ...
  Future<Database> database =
    ...
    await db.execute(
        "CREATE TABLE location(id INTEGER PRIMARY KEY, longitude REAL, latitude REAL, cell_id TEXT, speed REAL, activity TEXT, sample INTEGER, timestamp TEXT UNIQUE, exposure INTEGER DEFAULT 0, reported INTEGER DEFAULT 0)");
